...
<body>
    ...
    <?php
        ...
        function computePizzaTotal($pizzaPrice, $toppings, $toppingsMenu, $qty) {
            $toppingsTotal = 0;

            if (!empty($toppings)) {
                foreach ($toppings as $top) {
                    $toppingsTotal += $toppingsMenu[$top];
                }
            }
                ...
                <form method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio-group">
                            ...
                            <?php foreach ($pizzaMenu as $pizza => $price): ?>
                                <div class="radio-item">
                                    <input type="radio" id="<?= $pizza ?>" name="pizza" value="<?= $pizza ?>" required>
                                    <label for="<?= $pizza ?>">
                                        <?= $pizza ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="checkbox-group">
                            ...
                            <?php foreach ($toppingsMenu as $topping => $price): ?>
            ...
            <div class="card">
                ...
                <?php
                    if (isset($_POST['order'])) {
                        ...
                        $total = computePizzaTotal($pizzaPrice, $toppings, $toppingsMenu, $qty);

                        // TODO: 6. Display Results
                        echo "<div class='summary-item'><span>Customer:</span><span>$customer</span></div>";
                        echo "<div class='summary-item'><span>Pizza:</span><span>$pizza (₱$pizzaPrice)</span></div>";
            ...
            <div class="card full-width order-counter">
                ...
                <?php
                    if (isset($_POST['order'])) {
                        ...
                        for ($i = 1; $i <= $qty; $i++) {
                            echo "<div class='order-item'>🍕 Order #$i - $pizza</div>";
                        }
                    }
                ?>
            </div>
